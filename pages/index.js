              ...
              <div className={homeStyles.profile__areaLabelTxt}>
                ...
                <div className={homeStyles.profile__areaTxt}>
                  <ul className={homeStyles.profile__list}>
                    ...
                    <li className={`${homeStyles.profile__item}`} data-aos="fade-up" data-aos-duration="2000">その後フォーム構築やデータベース等、WEBサイト制作においての幅広い知識に触れ、現在はReact(Next.js)やLaravel等のワンランク上のスキルを磨いている最中。</li>
                  </ul>
