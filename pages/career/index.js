              ...
              <div className={homeStyles.profile__areaLabelTxt}>
                ...
                <div className={`${homeStyles.profile__areaTxt} profile__areaTxt`}>
                  <ul className={homeStyles.profile__list}>
                    <li className={`${homeStyles.profile__item} profile__item`} data-aos="fade-up" data-aos-duration="2000"><span className={homeStyles.profile__name}>Y.S<span className={homeStyles.profile__nameEn}></span></span></li> 
